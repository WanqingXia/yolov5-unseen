...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # Process 0
    if RANK in [-1, 0]:
        random_number = 5000 # number of random images picked and used in validating
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='yolov5s.pt', help='initial weights path') # initial weight, disabled
    parser.add_argument('--cfg', type=str, default='yolov5s.yaml', help='model.yaml path') # using yolov5x
    parser.add_argument('--data', type=str, default='data/ycb_unseen.yaml', help='dataset.yaml path')# data.data file
...
def main(opt):
    ...
    # DDP mode (Distributed Data Parallel for multi-GPU training)
...
def run(**kwargs):
    # Usage: import train; train.run(data='coco128.yaml', imgsz=320, weights='yolov5x.pt')
    opt = parse_opt(True)
